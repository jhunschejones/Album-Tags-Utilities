defmodule AlbumTagsWeb.MigrationController do
  ...
  def add_tag(conn, %{"text" => text, "user_id" => user_id, "custom_genre" => custom_genre, "album_id" => album_id}) do
    {:ok, tag} = Albums.find_or_create_tag(%{text: text, user_id: user_id, custom_genre: custom_genre})
